...
func ValidateAccountInGenesis(
	...
	var stakingData srstakingtypes.GenesisState
	cdc.MustUnmarshalJSON(appGenesisState[srstakingtypes.ModuleName], &stakingData)
...
// of the srstaking module's ApplyAndReturnValidatorSetUpdates.
func DeliverGenTxs(
