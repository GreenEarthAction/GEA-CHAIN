...
var (
	pattern_Query_Evidence_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"gea-poa", "evidence", "evidence_hash"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AllEvidence_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"gea-poa", "evidence"}, "", runtime.AssumeColonVerbOpt(true)))
)
