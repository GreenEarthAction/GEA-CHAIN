...
export const Params = {
  encode(message: Params, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.govPowerDenom !== "") {
      writer.uint32(58).string(message.govPowerDenom);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 7:
          message.govPowerDenom = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): Params {
    return {
      ...
      govPowerDenom: isSet(object.govPowerDenom) ? String(object.govPowerDenom) : "",
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.govPowerDenom !== undefined && (obj.govPowerDenom = message.govPowerDenom);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.govPowerDenom = object.govPowerDenom ?? "";
    return message;
  },
};
